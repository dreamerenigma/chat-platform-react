...
export const postNewMessage = (conversationId: number, data: CreateMessageParams) => 
...
export const fetchGroupMessages = (id: number) => axios.get<FetchGroupMessagePayload>(`/groups/${id}/messages`, config);
